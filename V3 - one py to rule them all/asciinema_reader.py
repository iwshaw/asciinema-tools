...
def convert_time(offset):
	...
	this_utc = datetime.fromtimestamp(start_time_unix_int + offset_int + 10800).isoformat()[11:] # 10800s is three hours for local time
	return this_utc
    ...
    with open(filename, errors='ignore') as f:
        ...
        while True: # this looks like a terrible idea but welcome to python
            ...
            if not new_line:
                ...
                if(len(content)>9): # if it's long, it's CLI output so return the time and the line
